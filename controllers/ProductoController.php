            ...
            if ($nombre && $precio) {
                try {
                    ...
                    if ($id) {
                        ...
                        if ($exito) {
                            LogDAO::save($id, 'producto', 'UPDATE', "Se ha actualizado el producto: $nombre (ID: $id)");
                        }
                    } else {
                        // === MODO CREAR (INSERT) ===
                        ...
                        if ($nuevo_id) {
                            $exito = true;
                            LogDAO::save($nuevo_id, 'producto', 'CREATE', "Se ha creado el producto: $nombre");
                        }
                    }
    ...
    public function borrar()
    {
        ...
        if (isset($_GET['id'])) {
            ...
            if ($productoDAO->delete($id)) {
                // REGISTRO DE LOG
                LogDAO::save($id, 'producto', 'DELETE', "Se ha eliminado el producto con ID: $id");
