    ...
    <div class="row">
        <div class="col-md-2" style="border-radius: 10px;">
            <div class="list-group mt-3">
                ...
                <button id="btn-productos" class="list-group-item list-group-item-action text-dark">
                    Gestion Productos
                </button>
                <button id="btn-pedidos" class="list-group-item list-group-item-action text-dark">
                    Gestion Pedidos
                </button>
                <button id="btn-usuarios" class="list-group-item list-group-item-action text-dark">
                    Gestion Usuarios
                </button>
                <button id="btn-logs" class="list-group-item list-group-item-action text-dark">
                    Logs
                </button>
            </div>
        </div>
